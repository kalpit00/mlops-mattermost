"""
Promotion gate CLI: ``python -m mlops_data.pipelines.cli_promotion_gate``
...
def main(argv: list[str] | None = None) -> int:
    ...
    from mlops_data.pipelines.promotion_gate import PromotionGateConfig, PromotionGateError, run_promotion_gate
