...
**Schedule** — ``python -m mlops_data.pipelines.cli_monitoring`` (cron / CI).
...
def run_monitoring(*, config: Optional[MonitoringConfig] = None) -> dict[str, Any]:
    ...
    report["promotion_integration"] = {
        "note": (
            "Point mlops_data.pipelines.cli_promotion_gate at this file via MLOPS_PROMOTION_MONITOR_JSON "
