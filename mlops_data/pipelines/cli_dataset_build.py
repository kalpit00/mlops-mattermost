"""
CLI: ``python -m mlops_data.pipelines.cli_dataset_build`` from repository root.
...
def main(argv: list[str] | None = None) -> int:
    ...
    from mlops_data.pipelines.dataset_build import DatasetBuildConfig, run_dataset_build
